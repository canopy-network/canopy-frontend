...
interface DestinationCurrencyDialogProps {
  open: boolean;
...
export default function DestinationCurrencyDialog({
  open,
  onOpenChange,
  onSelectToken,
  connectedWallets,
  onConnectWallet,
}: DestinationCurrencyDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md p-0 gap-0">
        <DialogHeader className="px-6 pt-6 pb-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">Choose where to receive your stablecoins</p>
        </DialogHeader>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-3 flex items-center justify-between transition-colors ${
                            !isLoading ? "hover:bg-muted/50 cursor-pointer" : "opacity-50 cursor-not-allowed"
                          }`}
                        >
