...
export default function LiquidityWithdrawDialog({
  ...
  const [view, setView] = useState<"confirm" | "pending" | "success">("confirm"); // 'confirm', 'pending', 'success'
          ...
          <>
            <div className="p-6 pt-6 pb-4">
              ...
              <div className="text-center space-y-1.5 mb-4">
                <h2 className="text-xl font-bold">
                  ...
                  <span className="text-muted-foreground">{tokenA.symbol}</span> and{" "}
            ...
            <div className="px-6 space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm font-semibold">${(250.9 - totalUSD).toFixed(2)}</p>
              </div>
            ...
            <div className="p-6 pt-4">
              <Button className="w-full h-11 text-base" size="lg" onClick={handleWithdraw}>
                Withdraw
              </Button>
            </div>
          </>
        ...
        {view === "pending" && (
          <div className="p-6 pt-12 pb-6 flex flex-col items-center">
            ...
            <p className="text-sm text-muted-foreground text-center mb-6">
              Removing {amountAValue.toFixed(2)} {tokenA.symbol} and {amountBValue.toFixed(2)} {tokenB.symbol} from the
              pool
            </p>
          ...
          <div className="p-6 pt-8 pb-6 flex flex-col items-center">
            ...
            <div className="w-full space-y-2 mb-6">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">${totalUSD.toFixed(2)}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Remaining Position</span>
                <span className="text-sm font-medium">${(250.9 - totalUSD).toFixed(2)}</span>
              </div>
            </div>

            <Button variant="secondary" className="w-full h-10 text-sm" size="lg" onClick={handleDone}>
              Close
            </Button>
          </div>
        )}
