  ...
  return (
    <Card className="w-full space-y-4 lg:px-6 px-4 lg:py-6 py-4">
      <div className="w-full overflow-x-auto">
        <div className="min-w-[640px] w-full lg:min-w-auto space-y-2">
          <div className="secondary-table-row flex items-center w-full text-muted-foreground text-xs py-1 lg:py-3 px-4">
            ...
            <span className="min-w-[152px] lg:min-w-[220px] ">Token</span>
            <span className="min-w-[124px] lg:w-[192px] mr-4">Price</span>
            <span className="min-w-[96px] lg:w-[172px] mr-4">Balance</span>
            <span className="flex items-center  ml-[auto] text-right">
              USD Value
            </span>
          </div>
          <div className="secondary-table-body flex flex-col gap-2">
            {data.assets.map((asset, index) => (
              ...
              >
                ...
                <div className="flex items-center py-3 leading-none gap-2 min-w-[152px] lg:min-w-[220px] ">
                  <Link
                    href={`/chains/${asset.id}`}
                    className="text-white text-xs font-bold hover:underline"
                  >
                    {asset.token}
                  </Link>
                </div>
                <div className="min-w-[124px] lg:w-[192px] mr-4 py-3 leading-none flex items-center">
                  {asset.price !== null ? (
                ...
                <div className="min-w-[96px]  lg:min-w-[172px] mr-6 pr-4 py-3 leading-none flex items-center">
                  {asset.balance !== null ? (
                    <span>
                ...
                <div className="flex items-center py-3 leading-none text-right ml-auto">
                  {asset.usdValue !== null ? (
                    <span>
                      $
