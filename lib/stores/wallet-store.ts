...
export interface WalletState {
  ...
  deleteOrder: (
    orderId: string,    // Order ID to delete (hex string)
      ...
      deleteOrder: async (
        ...
        try {
          ...
          const txParams = {
            type: 'deleteOrder',
            msg,
            fee: feeParams.deleteOrderFee || feeParams.createOrderFee, // Fallback to createOrderFee if deleteOrderFee not defined
            memo: "",
            networkID: 1,
